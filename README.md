...
│
├── Day-03/
│   ├── buy_sell_stock_multiple_transactions.cpp
│   ├── buy_sell_stock_single_transaction.cpp
│   ├── minimize_height_II.cpp
│   └── notes.md
│
├── Day-04/
...
│
├── Day-05/
│   ├── add_two_binary_strings.cpp
│   ├── atoi_implementation.cpp
│   ├── check_anagram.cpp
...
│   ├── minimum_characters_for_palindrome.cpp
